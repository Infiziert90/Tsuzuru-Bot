...
@register_command('x264', is_enabled=None, description='Post some links for x264')
...
@register_command('avisynth', is_enabled=None, description='Post some links for Avisynth')
...
@register_command('vapoursynth', is_enabled=None, description='Post some links for Vapoursynth')
...
@register_command('yuuno', is_enabled=None, description='Post some links for Yuuno')
...
@register_command('__lolz', is_enabled=None, description='Useless function.')
...
@register_command('send_message', is_enabled=None, description='Useless function.')
